...
func _physics_process(_delta):
	...
	torso_joint.set_param_x(
		JoltGeneric6DOFJoint3D.PARAM_LINEAR_LIMIT_LOWER, steer_lean_amount)
	torso_joint.set_param_x(
		JoltGeneric6DOFJoint3D.PARAM_LINEAR_LIMIT_UPPER, steer_lean_amount)
